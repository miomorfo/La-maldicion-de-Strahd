...
**Vasham**: Mago humano de edad desconocida. Siempre tiene un conjuro adecuado para el momento exacto (o eso cree él). Su poder y conocimiento son un misterio.
...
Una fogata, o lo que parece serlo, atrae a los personajes. Reunidos alrededor, discuten sus planes; el destino los atrajo a aquel fuego, pero nadie tiene un plan ni objetivos claros. En eso, la noche los alcanza poco a poco. Con las últimas luces del día, se ven atacados por sombras.
...
Luego de recuperarse, el grupo corrió para cruzar al otro lado de la reja de metal. El portón, visiblemente oxidado, tuvo que ser empujado con fuerza por Torken y Tartuk para lograr cerrarlo y mantener así a las criaturas alejadas, ayudándose con la luz de una antorcha.

Kirdal montó sobre el animal de tiro —un caballo blanco que estaba uncido a la carreta de viaje— mientras Torken revisaba la parte trasera del carruaje. Allí encontró un cofre que contenía una piedra grabada con runas, un montón de manzanas y varios ropajes de viaje.
